...
| Logistics | `/api/v1/logistics` | `GET /pending-dispatch`, `GET /operations-summary`, `GET /reconciliation-export` | Protected | Focused internal dispatch queue plus operations summary and reconciliation CSV export. Reconciliation is still internal-first even though Phase 13A adds separate manual external courier foundation routes. |
