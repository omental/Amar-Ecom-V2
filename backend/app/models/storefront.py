...
class StorefrontSetting(Base):
    ...
    active_template_key: Mapped[str] = mapped_column(String(100), nullable=False, default="live_shopping_classic", server_default="live_shopping_classic")
    typography_preset: Mapped[str] = mapped_column(String(100), nullable=False, default="modern_commerce", server_default="modern_commerce")
    color_preset: Mapped[str] = mapped_column(String(100), nullable=False, default="live_red", server_default="live_red")
    animation_preset: Mapped[str] = mapped_column(String(100), nullable=False, default="subtle_fade", server_default="subtle_fade")
    product_card_style: Mapped[str] = mapped_column(String(100), nullable=False, default="compact_deal", server_default="compact_deal")
    button_style: Mapped[str] = mapped_column(String(100), nullable=False, default="rounded", server_default="rounded")
    header_layout: Mapped[str] = mapped_column(String(100), nullable=False, default="search_heavy", server_default="search_heavy")
    footer_layout: Mapped[str] = mapped_column(String(100), nullable=False, default="multi_column", server_default="multi_column")
    spacing_density: Mapped[str] = mapped_column(String(100), nullable=False, default="compact", server_default="compact")
    corner_radius: Mapped[str] = mapped_column(String(100), nullable=False, default="soft", server_default="soft")
    shadow_style: Mapped[str] = mapped_column(String(100), nullable=False, default="soft", server_default="soft")
